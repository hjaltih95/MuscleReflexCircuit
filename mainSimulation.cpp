...
int main() {
    ...
    try {
        ...
        // Activation
        original1->setDefaultActivation(0.1);
        ...
        SimpleSpindle* spindle = new SimpleSpindle("muscle_spindle", *original1, optimalFiberLength);
        
        GolgiTendon* golgi = new GolgiTendon("muscle_golgi", *original1);
